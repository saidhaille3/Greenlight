...
<div class="ps-article">
  ...
  <div class="ps-section">
    <span class="ps-section-label">Mechanics</span>
    <h2 class="ps-section-title">Movement Profile</h2>
    <span class="ps-rule"></span>
  </div>

  <p>This is a straight-line player without much bend in his frame. Limited hip flexibility shows up directly in how he navigates contact -- when a defender gets into his body on a drive, he doesn't have the rotational give to slide around it, so he either bulldozes through or gets stood up.</p>

  <p>The ankles read stiff rather than springy, which kills his ability to decelerate and re-accelerate at a different angle. Compact, short strides rather than long ones, which limits how much ground he covers per move and forces him into more dribbles to manufacture the same separation a longer-strided guard gets in one or two touches.</p>
  ...
  <p>Off the ball, he's a decent mover -- relocating with real purpose on set plays, showing good chemistry in close-quarters actions. The give-and-go reads are sharp: he'll juke his defender with a quick fake one direction, slip backdoor or curl into open space, and catch in rhythm. He's comfortable functioning as a catch-and-shoot weapon within structure rather than needing to create everything himself.</p>

  <p>The shot mechanics aren't pretty. There's a hitch and a funkiness to the release that draws comparisons to Kenyon Martin Jr. -- unconventional, a little stiff through the load phase -- but the results are there regardless of how it looks. He wasn't expected to be an elite three-point shooter coming into the season, and that was one of the bigger pre-draft question marks on him, but he completely flipped that narrative. The range is the headline trait. He shows real depth beyond the arc, and that shooting gravity is clearly his most translatable, special-level skill.</p>

  <div class="ps-pull"><p>The vision is legitimate. He's flashed genuine no-look passes that suggest real processing speed, and the decent vision he shows attacking downhill -- finding cutters and shooters off two-foot gathers -- is a real plus.</p></div>

  <p>The bullet passes are accurate and well-timed into tight windows, not just flashy. He has what's likely the best floater in this draft class, with real touch whether he's shooting it on the move or stopping on a dime first.</p>

  <p>The driving package shows decent burst specifically off a between-the-legs setup move. Outside of that move, athleticism isn't the engine of his offense. He's not a high-flying finisher, and based on what I've seen, his layups are going to get sent into the stands repeatedly once he's facing NBA size and verticality at the rim.</p>

  <div class="ps-divider"></div>

  <div class="ps-section">
    <span class="ps-section-label">The Other End</span>
    <h2 class="ps-section-title">Defensive Profile</h2>
    <span class="ps-rule"></span>
  </div>

  <p>This is where the warning signs cluster hardest. He gets overaggressive jumping into help-defense rotations -- leaving his assigned man early to crash toward the ball -- which works occasionally as a gambling steal attempt but more often just creates an open shooter.</p>

  <p>When he's tasked with picking up a new man after a switch or a rotation, his reaction is consistently a half-step slow, like he's still mentally processing the previous action rather than immediately locking onto the new assignment. He dies on screens, gets beat off the dribble too easily, and frankly doesn't play with nearly enough effort on this end -- that part of the evaluation isn't just my read, it's been a consistent theme among scouts who've watched him all year.</p>
  ...
  <div class="ps-section">
    <span class="ps-section-label">Where I Differ</span>
    <h2 class="ps-section-title">The Disconnect</h2>
    <span class="ps-rule"></span>
  </div>

  <div class="ps-weakness-card">
    <span class="ps-w-label">Film Room Concern</span>
    <p>Here's where my evaluation splits hard from the industry consensus, and I want to be upfront about that gap rather than pretend it doesn't exist. Acuff has been invited to the NBA Draft Green Room, reserved for prospects the league expects to go in the lottery.</p>
    <p>Some scouts now view him as the top point guard in this entire class, ahead of Flemings, Wagler, and Philon. The most recent mocks have him going as high as 5th overall, sandwiched between players widely considered the consensus top tier of this draft.</p>
    <p>I'm not buying it. The shooting development is real and the floater is a legitimate weapon, but a green room invite and a top-five mock placement don't erase what shows up on defensive film -- the gambling, the slow recovery, the off-ball lapses -- or the movement limitations that make him so dependent on craft rather than physical tools to create any separation at all.</p>
  </div>
  ...
  <div class="ps-projection">
    <p>The league can fall in love with shot-making and scoring volume. I'm grading the whole player, both ends of the floor, and what I see on defense and in his movement profile caps him for me.</p>
    <p>The shooting and passing are real, but the defensive habits and the athletic ceiling are significant enough that I'm not willing to grade him as a lottery-caliber two-way piece.</p>
    <p>Second round is where I have him, buzz be damned.</p>
  </div>

  <div class="ps-grade-banner">
    <span class="ps-grade-num">2nd RD</span>
    <span class="ps-grade-caption">My Grade · 2026 NBA Draft</span>
  </div>
